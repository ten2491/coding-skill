...
public class GameFrame extends JFrame implements Runnable {
	...
	private void addButtonsOnPanel(JPanel panel) {
		...
		ActionListener generateRandomBtnAction = new ActionListener() {

			public void actionPerformed(ActionEvent event) {
				//乱数のパターン生成
				CellPattern.patternGenerator(cell_matrix, CellPattern.Pattern.RANDOM);
			}
		...
		btnSources.put("乱数", generateRandomBtnAction);
